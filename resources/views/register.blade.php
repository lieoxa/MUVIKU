    ...
    <style>
        ...
        body {
            ...
            background: linear-gradient(to bottom, rgba(15, 23, 42, 0.4), rgba(15, 23, 42, 0.85)), 
                        url('img/image.jpg') no-repeat center center fixed;
...
<body>
    <div class="register-card">
        <h1 class="header-title">BUAT AKUN</h1>
        ...
        <form action="{{ route('register') }}" method="POST">
            ...
            <div class="mb-2">
                ...
                <div class="input-group-custom">
                    <input type="text" name="name" class="fc required" id="name" 
                        onkeyup="enableSubmit()" placeholder="Ketik nama anda..">
                </div>
            </div>
            ...
            <div class="mb-2">
                ...
                <div class="input-group-custom">
                    <input type="text" name="nohp" class="fc required" id="nohp" 
                        onkeyup="enableSubmit()" placeholder="Ketik no. handphone anda..">
                </div>
            </div>
            ...
            <div class="mb-2">
                ...
                <div class="input-group-custom">
                    <input type="password" name="password" class="fc required" id="password" 
                        onkeyup="enableSubmit()" placeholder="Ketik sandi anda.." autocomplete="new-password">
                    <i class="bi bi-eye password-toggle" id="togglePassword"></i>
                </div>
            </div>

            <div class="mb-3">
                <label for="konfirmasi_password" class="form-label">Konfirmasi Sandi</label>
                <div class="input-group-custom">
                    <input type="password" name="password_confirmation" class="fc required" id="konfirmasi_password" 
                        onkeyup="enableSubmit()" placeholder="Ketik ulang sandi anda.." autocomplete="new-password">
                    <i class="bi bi-eye password-toggle" id="toggleKonfirmasiPassword"></i>
                </div>
            </div>

            <button type="submit" class="btn-primary-custom" id="submitBtn" disabled>Daftar</button>
        </form>
    ...
    <script>
        ...
        toggleKonfirmasiPasswordButton.addEventListener("click", function() {
            ...
            if (type === 'text') {
                ...
                toggleKonfirmasiPasswordButton.classList.add("bi-eye-slash");
            } else {
                toggleKonfirmasiPasswordButton.classList.remove("bi-eye-slash");
