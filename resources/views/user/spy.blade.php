...
<body>
    <section>
        ...
        <div class="full mb-3">
            <img src="img/comedy.jpg" class="w-100 thumbnail-detail" alt="...">
            <div class="parent position-relative">
                <div class="half mb-4 pt-5"
                    ...
                    <div class="title mb-2 d-flex justify-content-between">
                        <h1 class="fw-bolder">Spy</h1>
                    </div>

                    <div class="d-flex gap-2" style="font-size: 15px">
                        <div class="tahun w-auto">2015</div>
                        <div class="umur w-auto bg-secondary px-1">13+</div>
                        <div class="durasi w-auto">2j 10m</div>
                    </div>
                    <h6 class="d-flex" style="font-size:0.9rem">Perusahaan : <p class="ms-1">Chernin Entertainment</p>
                    </h6>
                    <h6 class="mb-2 d-flex" style="font-size:0.9rem">Sutradara : <p class="ms-1">Paul Feig</p>
                    </h6>
                    <div class="btn-play">
