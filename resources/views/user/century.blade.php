...
<body>
    <section>
        ...
        <div class="full mb-3">
            <img src="img/drakor1.jpg" class="w-100 thumbnail-detail" alt="...">
            <div class="parent position-relative">
                <div class="half mb-4 pt-5"
                    ...
                    <div class="title mb-2 d-flex justify-content-between">
                        <h1 class="fw-bolder">20th Century Girl</h1>
                    </div>

                    <div class="d-flex gap-2" style="font-size: 15px">
                        <div class="tahun w-auto">2022</div>
                        <div class="umur w-auto bg-secondary px-1">13+</div>
                        <div class="durasi w-auto">1j 59m</div>
                    </div>
                    <h6 class="d-flex" style="font-size:0.9rem">Perusahaan : <p class="ms-1">Yong Film Inc</p>
                    </h6>
                    <h6 class="mb-2 d-flex" style="font-size:0.9rem">Sutradara : <p class="ms-1">Bang Woo-ri</p>
                    </h6>
                    <div class="btn-play">
                    ...
                    <div class="desk">
                        <p> siswa SMA bernama Na Bo Ra yang memiliki sahabat, yakni Yeon Doo. Keduanya melewati masa
                            sekolah sebagai remaja bersama-sama. Cerita bermula ketika Na Bo Ra mendapatkan <span
                                class="additional-text">paket berisi
                                barang-barang yang membawa ingatan tentang masa sekolahnya. Tepatnya sekitar tahun 1999.
                                Kala itu, Na Bo Ra teringat akan kehidupannya sebagai seorang siswi. Termasuk sahabat
                                dan kisah asmara dengan cinta pertamanya. Saat masih sekolah, Na Bo Ra sempat terpisah
                                dengan Yeon Doo. Lantaran sang sahabat harus mendapatkan tindakan operasi jantung yang
                                dilakukan di Amerika. Sebelum itu, Yeon Doo terpana dengan siswa laki-laki yang
                                membuatnya malas untuk bertolak ke Amerika. Tentu saja ia menceritakan hal tersebut
                                kepada Na Bo Ra sebagai sahabatnya. Anehnya, Yeon Doo tidak mengenal baik siapa pria
                                tersebut. Satu hal yang diketahuinya adalah nama. Siswa di sekolah yang sama, sosok
                                tersebut bernama Baek Hyun Jin. Sementara itu, Na Bo Ra sudah tahu benar bahwa Yeon Doo
                                mudah tertarik dengan laki-laki. Maka dari itu, ia tidak begitu menaruh perhatiannya
                                kepada curhatan Yeon Doo.
                            </span>
                    ...
                    <div class="scroll-horizontal  d-flex">
                        <section class="relate" id="relate">
                            <div class="img-relate d-flex row g-1" style="max-width: 100vw">
                                <div class="col-4">
                                    <img src="img/drakor2.jpg">
                                </div>
                                <div class="col-4">
                                    <img src="img/drakor3.jpg">
                                </div>
                                <div class="col-4">
                                    <img src="img/drakor4.jpg">
                                </div>
                                <div class="col-4">
                                    <img src="img/drakor5.jpg">
                                </div>
                            </div>
                        </section>
                    </div>
