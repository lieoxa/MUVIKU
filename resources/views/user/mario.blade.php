    ...
    <section>
        <nav class="navbar ps-2 pe-3 sticky-top w-100 p-0 d-flex justify-content-between" style="height:68.59px;"
            ...
            <div class="d-flex gap-3" style="height: 68.58px">
                <button onclick="window.history.go(-1)" class="btn1 border-0"><i
        ...
        <div class="full mb-3">
            <img src="img/animasi1.jpg" class="w-100 thumbnail-detail" alt="...">
            <div class="parent position-relative">
                <div class="half mb-4 pt-5"
                    ...
                    <div class="title mb-2 d-flex justify-content-between">
                        <h1 class="fw-bolder">The Super Mario Bros Movie</h1>
                    </div>

                    <div class="d-flex gap-2" style="font-size: 15px">
                        <div class="tahun w-auto">2023</div>
                        <div class="umur w-auto bg-secondary px-1">13+</div>
                        <div class="durasi w-auto">1j 32m</div>
                    </div>
                    <h6 class="d-flex" style="font-size:0.9rem">Perusahaan : <p class="ms-1">Universal Pictures,
                            Illumination, Nintendo
                        </p>
                    </h6>
                    <h6 class="mb-2 d-flex" style="font-size:0.9rem">Sutradara : <p class="ms-1">Aaron Horvath,
                            Michael jelenic</p>
                    </h6>
                    <div class="btn-play">
