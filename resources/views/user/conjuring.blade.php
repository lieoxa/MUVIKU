...
<body>
    <section>
        ...
        <div class="full mb-3">
            <img src="img/horror10.jpg" class="w-100 thumbnail-detail" alt="...">
            <div class="parent position-relative">
                <div class="half mb-4 pt-5"
                    ...
                    <div class="title mb-2 d-flex justify-content-between">
                        <h1 class="fw-bolder">The Conjuring</h1>
                    </div>

                    <div class="d-flex gap-2" style="font-size: 15px">
                        <div class="tahun w-auto">2013</div>
                        <div class="umur w-auto bg-secondary px-1">17+</div>
                        <div class="durasi w-auto">1j 52m</div>
                    </div>
                    <h6 class="d-flex" style="font-size:0.9rem">Perusahaan : <p class="ms-1"> New Line Cinema
                        </p>
                    </h6>
                    <h6 class="mb-2 d-flex" style="font-size:0.9rem">Sutradara : <p class="ms-1">James Wan</p>
                    </h6>
                    <div class="btn-play">
                    ...
                    <div class="desk">
                        <p>Film ini mengisahkan tentang investigasi paranormal untuk membantu keluarga Perron (Ron
                            ...
                            Harrisville, Rhode Island, pada tahun 1971.[6]<span class="additional-text">
                                ...
                                keluarga ini berjalan lancar, meskipun anjing mereka, Sadie, menolak memasuki rumah dan
                                salah satu anak perempuan mereka menemukan sebuah pintu masuk ke ruang bawah tanah.

                                Keesokan paginya, Carolyn bangun dengan memar misterius dan menemukan Sadie tergeletak
                                mati di luar rumah. Selama beberapa hari berikutnya, berbagai peristiwa misterius
                                terjadi. Peristiwa ini memuncak pada suatu malam saat Roger berada di Florida, Carolyn
                                terkunci di ruang bawah tanah dan sesosok makhluk gaib yang terlihat seperti seorang
                                wanita tua menyerang salah satu putrinya.</span>
