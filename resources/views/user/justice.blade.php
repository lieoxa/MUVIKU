...
<body>
    <section>
        ...
        <div class="full mb-3">
            <img src="img/hero14.jpg" class="w-100 thumbnail-detail" alt="...">
            <div class="parent position-relative">
                <div class="half mb-4 pt-5"
                    ...
                    <div class="title mb-2 d-flex justify-content-between">
                        <h1 class="fw-bolder">Justice League</h1>
                    </div>

                    <div class="d-flex gap-2" style="font-size: 15px">
                        <div class="tahun w-auto">2017</div>
                        <div class="umur w-auto bg-secondary px-1">13+</div>
                        <div class="durasi w-auto">2j</div>
                    </div>
                    <h6 class="d-flex" style="font-size:0.9rem">Perusahaan : <p class="ms-1">Marvel Studios
                        </p>
                    </h6>
                    <h6 class="mb-2 d-flex" style="font-size:0.9rem">Sutradara : <p class="ms-1">Zack Snyder</p>
                    </h6>
                    <div class="btn-play">
                    ...
                    <div class="desk">
                        <p>Justice League film yang mengisahkan tentang misi Batman, Bruce Wayne (Ben Affleck) dan
                            Wonder Woman, Diana Prince (Gal Gadot) untuk mencegah niat jahat Steppenwolf yang berusaha
                            melenyapkan bumi. Batman akan membentuk sebuah tim superhero lain, serta berencana untuk
                            menghidupkan Superman, Clark Kent (Henry Cavil) yang telah mati.<span
                                class="additional-text">Kedatangan Steppenwolf tersebut untuk mencari tiga buah kotak
                                yang dikenal dengan “Mother Box”. Karena memiliki energi yang sangat besar dan terletak
                                di tiga tempat yang berbeda. Ketiga kotak tersebut disimpan oleh sekutu Amazon dan kotak
                                kedua terletak di dalam lautan yang dipegang oleh sekutu Atlantis. Kotak terakhir
                                dilindungi oleh manusia dan tersembunyi di sebuah tempat rahasia.

                                Steppenwolf dan timnya berhasil mengambil dua kota tersebut yang ada di sekutu Amazon
                                dan Atlantis. Mereka juga melanjutkan pencarian kotak ketiga yang belum diketahui
                                keberadaannya.

                                Selain itu, Batman dan Wonder Woman mulai mengumpulkan semua superhero. Mereka berhasil
                                mengajak Aquaman, Arthur Curry (Jason Momoa), Cyborg, Victor Stone (Ray Fisher), dan The
                                Flash/Barry Allen (Ezra Miller).

                                Walaupun mereka berdua sudah mengumpulkan para superhero kekuatan Steppenwolf masih
                                tidak bisa terkalahkan. Sehingga para superhero menemukan lokasi “Mother Box” ketiga.
                                Batman pun berniat untuk menggunakan kotak tersebut untuk menghidupkan kembali
                                Superman.</span>
                    ...
                    <div class="scroll-horizontal  d-flex">
                        <section class="relate" id="relate">
                            <div class="img-relate d-flex row g-1" style="max-width: 100vw">
                                <div class="col-4">
                                    <img src="img/hero10.jpg">
                                </div>
                                <div class="col-4">
                                    <img src="img/hero12.jpg">
                                </div>
                                <div class="col-4">
                                    <img src="img/hero13.jpg">
                                </div>
                                <div class="col-4">
                                    <img src="img/hero14.jpg">
                                </div>
                            </div>
                        </section>
                    </div>
