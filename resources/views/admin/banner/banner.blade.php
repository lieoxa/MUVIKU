            ...
            <div class="modal-dialog modal-dialog-centered  container">
                <div class="modal-content logout rounded-5">
                    <div class="modal-header border-bottom-0 text-center d-block pb-0">
                        <h1 class="modal-title fs-5" id="logoutLabel">Apakah Anda Yakin Ingin Menghapus Banner Ini?</h1>
                    </div>
                    <div class="modal-footer border-top-0 justify-content-center gap-2">
                        <form action="{{ route('banner.destroy', $item->id) }}" enctype="multipart/form-data"
                            method="POST">
                            @csrf
                            @method('delete')
